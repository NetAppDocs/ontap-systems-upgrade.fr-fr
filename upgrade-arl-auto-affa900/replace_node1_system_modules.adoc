...
=== Installez le module de contrôleur AFF A150 ou FAS2820

Utilisez la procédure suivante pour installer le module de contrôleur AFF A150 ou FAS2820 dans le nœud 1.
...
=== Installez les modules de contrôleur et la mémoire NVRAM du système AFF A900 ou FAS9500
