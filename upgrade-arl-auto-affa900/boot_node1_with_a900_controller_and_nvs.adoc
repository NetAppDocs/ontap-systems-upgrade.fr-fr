...
[cols="35,65"]
|===
| Contrôleur de nœud 1 existant | Remplacement des modules système du nœud 1 


| AFF A800 | AFF A90 ou AFF A70 ^1^ 


| AFF A220 configuré en tant que ASA | Module contrôleur AFF A150 ^1^ 
...
| AFF A700 configuré en tant que ASA | Contrôleur ASA A900 et modules NVRAM ^2^ 
...
.Étapes
. (Mise à niveau de AFF A800 uniquement) à l'invite du CHARGEUR, entrer en mode maintenance :
+
`boot_ontap maint`
