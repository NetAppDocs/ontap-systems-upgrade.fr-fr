...
[role="lead"]
Le nœud 1 avec les modules de remplacement est maintenant prêt pour le démarrage. Cette section fournit les étapes requises pour démarrer node1 avec les modules de remplacement pour les configurations de mise à niveau suivantes :
...
|===
^1^ la mise à niveau par permutation du module de contrôleur implique le déplacement de toutes les connexions de l'ancien vers le module de contrôleur de remplacement.
^2^ la mise à niveau en permutant le contrôleur et les modules NVRAM implique de déplacer uniquement la console et les connexions de gestion.
