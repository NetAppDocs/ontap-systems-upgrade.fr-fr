...
Après avoir initialisé le nœud 1 avec le module système de remplacement, vous devez vérifier qu'il est correctement installé. Vous devez patienter jusqu'à ce que le nœud 2 rejoint le quorum, puis reprendre l'opération de remplacement du contrôleur.
