...
NOTE: Étant donné que le châssis est déjà sous tension, le nœud 2 démarre dès qu'il est complètement installé. Pour empêcher le démarrage du nœud 2, connectez la console et les câbles de gestion avant d'insérer complètement le module de contrôleur.
