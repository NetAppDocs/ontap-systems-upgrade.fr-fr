...
. Attendre que le nœud 1 s'exécute sur le module de contrôleur ASA A900, AFF A900 ou FAS9500 pour démarrer et afficher les options du menu de démarrage comme illustré ci-dessous :
+
[listing]
----
