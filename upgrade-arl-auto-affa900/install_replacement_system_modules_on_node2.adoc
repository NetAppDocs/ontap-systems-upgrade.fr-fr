...
* <<install_modules_a,Installez le module de contrôleur ASA A150, AFF A150 ou FAS2820 sur le nœud 2>>
* <<install_modules_b,Installez les modules de contrôleur et NVRAM ASA A900, AFF A900 ou FAS9500 sur le node2>>
...
Utilisez la procédure suivante pour installer le module NVRAM ASA A900, AFF A900 ou FAS9500 dans le logement 6 du nœud 2.
...
Utilisez la procédure suivante pour installer le module de contrôleur ASA A900, AFF A900 ou FAS9500 dans le node2.
