...
Pour les mises à niveau de AFF A250, AFF C250, AFF A800 ou AFF C800 uniquement, vous mappez les ports physiques du nœud 1 existant vers le nœud de remplacement 1, car les ports physiques changent entre les contrôleurs existants et de remplacement.

Pour toutes les autres mises à niveau, vous n'avez pas besoin de mapper les ports physiques du nœud 1 existant au nœud 1 de remplacement.
