...
[role="lead"]
Le processus de remplacement du contrôleur commence par une série de vérifications préalables. Vous collectez également des informations sur les nœuds d'origine pour les utiliser ultérieurement dans la procédure. Si l'une de ces vérifications échoue, vous devez corriger la propriété des agrégats avant de poursuivre la mise à niveau.
