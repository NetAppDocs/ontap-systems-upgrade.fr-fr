...
| link:prepare_nodes_for_upgrade.html["Étape 1. Préparation de la mise à niveau"]  a| 
...
| link:relocate_non_root_aggr_nas_data_lifs_node1_node2.html["Étape 2. Transférez et retirez le nœud 1"]  a| 
...
| link:install_boot_node3.html["Étape 3. Installez et démarrez le nœud 3"]  a| 
...
| link:relocate_non_root_aggr_nas_lifs_from_node2_to_node3.html["Étape 4. Transférez et retirez le nœud 2"]  a| 
...
| link:install_boot_node4.html["Étape 5. Installez et démarrez Node4"]  a| 
...
| link:manage-authentication-using-kmip-servers.html["Étape 6. Terminez la mise à niveau"]  a| 
...
|===
.Et la suite ?
Après avoir pris connaissance de la séquence de mise à niveau ARLlink:prepare_nodes_for_upgrade.html["préparer les nœuds pour la mise à niveau"].
