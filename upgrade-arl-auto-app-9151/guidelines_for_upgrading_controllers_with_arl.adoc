...
En cas de problème lors de la mise à niveau des contrôleurs, reportez-vous à la section link:aggregate_relocation_failures.htmll["Résoudre les problèmes"] pour plus d'informations et pour obtenir des solutions.
