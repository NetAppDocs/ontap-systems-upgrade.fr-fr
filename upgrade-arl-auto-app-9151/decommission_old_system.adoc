...
summary: 'Faites savoir à NetApp que l"ancien système ne fonctionne plus après la mise à niveau des contrôleurs exécutant ONTAP 9.15.1 ou une version ultérieure à l"aide de `system controller replace` commandes.' 
---
...
.Et la suite ?
Après la mise hors service de l'ancien système, link:resume_snapmirror_operations.html["reprise des opérations SnapMirror"].
