...
.Et la suite ?
Après avoir déplacé les agrégats non racines et les LIF de données NAS du nœud 2 vers le nœud 3, link:relocate-failed-or-vetoed-aggr-node3.html["Déplacer les agrégats ayant échoué ou ayant fait l'objet d'un veto vers le nœud3"].
