...
| link:determine_aggregates_on_internal_drives.html["Étape 1 : préparer la mise à niveau"]  a| 
...
| link:relocate_non_root_aggr_node1_node2.html["Étape 2 : retrait du noeud 1"]  a| 
...
| link:install_boot_node3.html["Etape 3 : installation et démarrage du node3"]  a| 
...
| link:record_node2_information.html["Étape 4 : retirer le noeud 2"]  a| 
...
| link:install_boot_node4.html["Etape 5 : installation et démarrage du node4"]  a| 
...
| link:manage_authentication_kmip.html["Étape 6 : terminez la mise à niveau"]  a| 
...
NOTE: Les mises à jour de reprise après sinistre des machines virtuelles de stockage (SVM) ne sont pas interrompues conformément aux calendriers prévus.

La propriété globale n'a aucun changement.

|===
.Et la suite ?
Après avoir examiné le flux de travail de mise à niveau ARLlink:guidelines_upgrade_with_arl.html["Consultez les directives relatives à la mise à niveau des contrôleurs avec ARL"].
