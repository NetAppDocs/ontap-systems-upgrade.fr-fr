...
summary: 'Utilisez la procédure manuelle d"ARL pour mettre à niveau les contrôleurs de stockage d"une paire haute disponibilité avec les nouveaux contrôleurs exécutant ONTAP 9.8 ou une version ultérieure.' 
---
