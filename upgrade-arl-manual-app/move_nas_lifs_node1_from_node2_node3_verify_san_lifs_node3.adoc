...
.Et la suite ?
Après avoir déplacé les LIF de données NAS appartenant au nœud 1 du nœud 2 vers le nœud 3 et vérifié les LIF SAN sur le nœud 3, .
