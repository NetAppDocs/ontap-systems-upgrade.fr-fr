...
summary: 'Informations sur les problèmes susceptibles de se produire lors d"une mise à niveau manuelle du transfert d"agrégats sur des contrôleurs exécutant ONTAP 9.8 ou une version ultérieure.' 
---
