...
.Et la suite ?
Après avoir géré les clés d'authentification à l'aide du gestionnaire de clés intégré link:quiesce_snapmirror_relationships.html["quiescer les relations SnapMirror"].
