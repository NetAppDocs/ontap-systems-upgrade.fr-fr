...
.Et la suite ?
Après avoir examiné les directives de mise à niveau des contrôleurs avec ARL, link:required_tools_documentation.html["examiner les outils et la documentation requis"].
