...
|===
.Et la suite ?
Après avoir enregistré les informations du nœud d'origine, link:determine_aggregates_on_internal_drives.html["déterminer si le contrôleur possède des agrégats sur les disques durs internes"].
