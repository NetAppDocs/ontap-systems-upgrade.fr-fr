...
.Et la suite ?
Après avoir déterminé si le contrôleur possède des agrégats sur des disques durs internes, link:prepare_nodes_for_upgrade.html["préparer les nœuds pour la mise à niveau"].
