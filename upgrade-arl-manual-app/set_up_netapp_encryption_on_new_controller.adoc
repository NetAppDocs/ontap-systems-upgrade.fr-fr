...
.Et la suite ?
Après avoir configuré le chiffrement de volume ou d’agrégat NetApp sur le nouveau module de contrôleur, link:decommission_old_system.html["mettre hors service l'ancien système"].
