...
.Et la suite ?
Après avoir mappé les ports du nœud 1 au nœud 3, link:move_nas_lifs_node1_from_node2_node3_verify_san_lifs_node3.html["Déplacer les LIF de données NAS appartenant à node1 de node2 vers node3 et vérifier les LIF SAN sur node3"].
