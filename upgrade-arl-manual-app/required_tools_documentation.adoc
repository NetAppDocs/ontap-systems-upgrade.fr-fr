...
.Et la suite ?
Après avoir examiné les outils et la documentation nécessaires, link:worksheet_information_before_during_upgrade.html["Enregistrez les informations du nœud d'origine pour les utiliser lors de la mise à niveau"].
