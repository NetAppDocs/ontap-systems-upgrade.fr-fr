...
|===
.Et la suite ?
Après avoir enregistré les  `adapter` et  `switch-port` informations pour chaque LIF, link:relocate_non_root_aggr_node2_node3.html["déplacer les agrégats non racines du nœud2 vers le nœud3"].
