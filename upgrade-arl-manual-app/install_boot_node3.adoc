...
. Saisissez CTRL-C pour afficher le menu de démarrage.
...
.Et la suite ?
Après l'installation et le démarrage de node3, link:set_fc_uta_uta2_config_node3.html["définir la configuration FC ou UTA/UTA2 sur le nœud 3"].
