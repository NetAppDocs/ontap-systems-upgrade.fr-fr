...
Vous devrez peut-être le faire  FC ports on node3, ou  and configure UTA/UTA2 ports on node3, ou les deux sections.
...
| Est un système V-Series ou un logiciel de virtualisation FlexArray qui est connecté aux baies de stockage | Accédez à ,Étape 6. Vous devez déjà être en mode de maintenance. 
|===
