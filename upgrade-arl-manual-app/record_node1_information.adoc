...
+
Les domaines de diffusion doivent être associés aux nouveaux ports du nouveau contrôleur ultérieurement dans la procédure.
...
.Et la suite ?
Après l'enregistrement des informations du nœud 1, link:retire_node1.html["retirer node1"].
