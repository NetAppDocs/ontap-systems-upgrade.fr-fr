...
Reportez-vous à link:other-references.html["Références"] pour accéder à la liste des documents de référence et des sites de référence requis pour cette mise à niveau.

.Et la suite ?
Après avoir examiné les outils et la documentation nécessaires, link:guidelines-for-upgrading-controllers-with-arl.html["Découvrez les directives relatives à la mise à niveau des contrôleurs"].
