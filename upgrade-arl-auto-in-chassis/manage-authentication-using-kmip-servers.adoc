...
.Et la suite ?
Après avoir géré l'authentification à l'aide des serveurs KMIP, link:confirm-new-controllers-are-set-up-correctly.html["vérifier que les nouveaux contrôleurs sont correctement configurés"].
