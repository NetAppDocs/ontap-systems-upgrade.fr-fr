...
Installez le module de contrôleur AFF A90, AFF A70 ou AFF C80. Installez, câblez et connectez le module de contrôleur AFF A90, AFF A70 ou AFF C80 dans le nœud1.
