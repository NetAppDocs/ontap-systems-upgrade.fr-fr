...
.Et la suite ?
Après avoir câblé le nœud 2 pour le cluster partagé HA et le stockage, link:boot-node2-with-a900-controller-and-nvs.html["Démarrez le nœud 2 avec les modules système de remplacement"].
