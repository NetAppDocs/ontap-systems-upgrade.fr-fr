...
---
= Remplacez le module de contrôleur node1 AFF A250 ou AFF C250
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Remplacez le module de contrôleur AFF A250 ou AFF C250 du node1 par un module de contrôleur AFF A30, AFF A50, AFF C30 ou AFF C60.
...
Pour retirer le module contrôleur node1, retirez le dispositif de gestion des câbles et déverrouillez les loquets de verrouillage. Ensuite, retirez le module contrôleur du châssis.
...
.Et la suite ?
Après avoir installé le module de contrôleur AFF A30, AFF A50, AFF C30 ou AFF C60, link:netboot-node1.html["netboot node1"].
