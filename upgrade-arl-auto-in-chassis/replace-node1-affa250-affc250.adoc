...
Pour retirer le module contrôleur node1, retirez le dispositif de gestion des câbles et déverrouillez les loquets de verrouillage. Retirez ensuite le module contrôleur du châssis.
