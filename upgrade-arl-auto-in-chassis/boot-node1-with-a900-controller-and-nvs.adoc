...
[role="lead"]
Le nœud 1, équipé des modules de remplacement, est maintenant prêt à démarrer.  Les modules de remplacement pris en charge sont répertoriés dans lelink:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["matrice des systèmes pris en charge"] .
