...
[role="lead"]
Le nœud 1, équipé des modules de remplacement, est désormais prêt à démarrer. Les modules de remplacement compatibles sont listés dans le link:decide-to-use-the-aggregate-relocation-guide.html#supported-systems-in-chassis["matrice des systèmes pris en charge"].
...
.Et la suite ?
Après avoir démarré le nœud 1 avec les modules système de remplacement, link:verify-node1-installation.html["vérifiez l'installation du nœud 1"].
