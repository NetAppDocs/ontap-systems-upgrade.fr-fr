...
---
= Installez le module contrôleur ASA A150, AFF A150 ou FAS2820 dans le nœud 2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Installez le module de contrôleur ASA A150, AFF A150 ou FAS2820 que vous avez reçu pour la mise à niveau dans le nœud2. Le nœud2 est le contrôleur B situé sur le côté droit du châssis lorsque vous regardez les contrôleurs depuis l’arrière du système.
