...
.Et la suite ?
Après avoir restauré la configuration du gestionnaire de clés sur le nœud 1 mis à niveau, link:move-non-root-aggr-nas-lifs-node1-from-node2-to-upgraded-node1.html["Déplacez les agrégats non racine et les LIF de données NAS du nœud2 vers le nœud1 mis à niveau"].
