...
.Et la suite ?
Après avoir configuré le chiffrement du stockage sur le nouveau module de contrôleur, link:set-up-netapp-volum-encryption-new-module.html["Configurez le chiffrement de volume ou d’agrégat NetApp sur le nouveau module contrôleur"].
