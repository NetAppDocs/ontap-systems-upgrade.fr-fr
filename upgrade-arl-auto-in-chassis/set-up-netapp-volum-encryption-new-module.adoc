...
summary: 'Si nécessaire, configurez le nouveau module de contrôleur pour NVE ou NAE lors de l"utilisation d"ARL pour mettre à niveau les modèles de contrôleur dans le même châssis.' 
---
...
.Et la suite ?
Après avoir configuré le chiffrement de volume ou d’agrégat NetApp sur le nouveau module de contrôleur, link:decommission-old-system.html["mettre hors service l'ancien système"].
