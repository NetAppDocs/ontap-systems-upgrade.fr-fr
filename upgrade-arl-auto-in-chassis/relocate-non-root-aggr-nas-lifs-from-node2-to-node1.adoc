...
.Et la suite ?
Après avoir déplacé les agrégats non racines et les LIF de données NAS du nœud 2 vers le nœud 1, link:relocate-failed-or-vetoed-aggr-node1.html["déplacer les agrégats ayant échoué ou ayant fait l'objet d'un veto vers le nœud 1"].
