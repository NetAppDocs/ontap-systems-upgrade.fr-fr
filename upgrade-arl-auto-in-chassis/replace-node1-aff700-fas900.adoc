...
---
= Remplacez le contrôleur AFF A700 ou FAS9000 du nœud 1 et les modules NVRAM
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Remplacez les modules contrôleur et NVRAM AFF A700 ou FAS9000 du nœud 1 par des modules contrôleur et NVRAM ASA A900, AFF A900 ou FAS9500.
...
Détachez et retirez le module de contrôleur node1 AFF A700 ou FAS9000.
...
Déverrouillez et retirez le module NVRAM node1 AFF A700 ou FAS9000.
...
Installez, câblez et connectez le module NVRAM ASA A900, AFF A900 ou FAS9500 dans le nœud1.
...
== Étape 4 : Installez le module de contrôleur ASA A900, AFF A900 ou FAS9500 dans le nœud 1

Installez, câblez et connectez le module de contrôleur ASA A900, AFF A900 ou FAS9500 dans le nœud1.
...
. Après avoir interrompu AUTOBOOT, le nœud1 s'arrête à l'invite LOADER. Si vous n'interrompez pas AUTOBOOT à temps et que le nœud1 commence à démarrer, attendez l'invite et appuyez sur Ctrl-C pour accéder au menu de démarrage. Une fois le nœud arrêté sur le menu de démarrage, utilisez l'option `8` pour redémarrer le nœud et interrompre AUTOBOOT pendant le redémarrage.
...
.Et la suite ?
Après avoir installé les modules contrôleur ASA A900, AFF A900 ou FAS9500 et NVRAM, link:netboot-node1.html["netboot node1"].
