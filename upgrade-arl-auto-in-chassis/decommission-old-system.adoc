...
.Étapes
. Consultez link:other-references.html["Références"] pour accéder au _NetApp Support Site_ et connectez-vous.
...
.Et la suite ?
Après la mise hors service de l'ancien système, link:resume-snapmirror-operations.html["reprise des opérations SnapMirror"].
