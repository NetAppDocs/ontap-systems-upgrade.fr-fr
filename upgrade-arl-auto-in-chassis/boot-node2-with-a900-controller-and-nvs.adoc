...
[role="lead"]
Le Node2 équipé des modules de remplacement est désormais prêt à démarrer.  Les modules de remplacement pris en charge sont répertoriés dans lelink:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["matrice des systèmes pris en charge"] .
