...
[role="lead"]
Le nœud 2 avec les modules de remplacement est maintenant prêt à démarrer. Les modules de remplacement pris en charge sont répertoriés dans le link:index.html#supported-systems,["matrice des systèmes pris en charge"].
