...
+
Saisissez la phrase secrète et les informations de sauvegarde que vous avez enregistrées précédemment dans la procédure. Voir link:manage-storage-encryption-using-okm.html["Gérez le chiffrement du stockage à l'aide du gestionnaire de clés intégré"].
