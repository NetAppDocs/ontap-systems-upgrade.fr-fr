...
---
= Remplacez le module de contrôleur node1 AFF A220, AFF A200, AFF C190, FAS2620 ou FAS2720
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Remplacez le module de contrôleur node1 AFF A220, AFF A200, AFF C190, FAS2620 ou FAS2720 par un module de contrôleur ASA A150, AFF A150 ou FAS2820.
...
Pour accéder aux composants à l'intérieur du contrôleur node1, retirez le module de contrôleur du système, puis retirez le couvercle du module de contrôleur.
...
.Et la suite ?
Après avoir installé le module de contrôleur ASA A150, AFF A150 ou FAS2820, link:netboot-node1.html["netboot node1"].
