...
.Et la suite ?
Après avoir câblé le nœud 1 pour le cluster partagé HA et le stockage, link:boot-node1-with-a900-controller-and-nvs.html["démarrez le nœud 1 avec les modules système de remplacement"].
