...
.Et la suite ?
Après avoir restauré la configuration du gestionnaire de clés sur le nœud 2, link:verify-rcf-configuration.html["vérifier la configuration RCF sur les commutateurs de cluster"].
