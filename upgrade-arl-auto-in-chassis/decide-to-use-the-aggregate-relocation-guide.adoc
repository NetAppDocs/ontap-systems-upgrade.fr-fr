...
* Si vous préférez une autre méthode de mise à niveau du matériel du contrôleur et que vous êtes prêt à effectuer des déplacements de volumes, reportez-vous à link:other-references.html["Références"] pour accéder à _Mise à niveau par déplacement de volumes ou de stockage_.


.Informations associées
Reportez-vous à link:other-references.html["Références"] pour accéder à la documentation _ONTAP 9_.

.Et la suite ?
Après avoir décidé d'utiliser cette procédure ARL, link:required-tools-and-documentation.html["Découvrez les outils et la documentation requis."].
