...
| link:verify-upgrade-hardware.html["Étape 1 : préparer la mise à niveau"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["Étape 2 : relocaliser les ressources et retirer le nœud 1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["Étape 4 : déplacer les ressources et retirer le nœud 2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["Étape 5 : Installer les modules système de remplacement du nœud 2"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["Etape 6 : démarrez le nœud 2 avec les modules système de remplacement"]  a| 
...
|===
.Et la suite ?
Après avoir pris connaissance de la séquence de mise à niveau ARL, link:verify-upgrade-hardware.html["vérifier le matériel de mise à niveau"].
