...
summary: 'Si nécessaire, configurez Storage Encryption, installez les certificats SSL et configurez les serveurs de gestion des clés lors de la mise à niveau des contrôleurs exécutant ONTAP 9.8 ou version ultérieure à l"aide de `system controller replace` commandes.' 
---
