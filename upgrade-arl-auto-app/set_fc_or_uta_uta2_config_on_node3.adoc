...
| Est un système V-Series ou un logiciel de virtualisation FlexArray qui est connecté aux baies de stockage  a| 
** Si le nœud 3 dispose d'une carte UTA/UTA2 ou de ports intégrés UTA/UTA2, consultez la section <<Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>>.
** Si le nœud 3 ne dispose pas de carte UTA/UTA2 ou de ports intégrés UTA/UTA2, ignorez la section <<Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>> Et revenez à la section _Install and boot node3_ et reprenez à link:install_boot_node3.html#step23["Étape 23"].
