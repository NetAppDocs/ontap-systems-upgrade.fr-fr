...
** Si le nœud 3 ne dispose pas de carte UTA/UTA2 ou de ports intégrés UTA/UTA2, ignorez la section  and configure UTA/UTA2 ports on node3 et allez à la section link:verify_node3_installation.html["Vérifiez l'installation du noeud 3"].
...
** Si le nœud 3 dispose d'une carte UTA/UTA2 ou de ports intégrés UTA/UTA2, consultez la section  and configure UTA/UTA2 ports on node3.
** Si le nœud 3 ne dispose pas de carte UTA/UTA2 ou de ports intégrés UTA/UTA2, ignorez la section  and configure UTA/UTA2 ports on node3 Et revenez à la section _Install and boot node3_ et reprenez à link:install_boot_node3.html#step23["Étape 23"].
...
| Est un système V-Series ou un logiciel de virtualisation FlexArray qui est connecté aux baies de stockage | Retournez à la section _Install and boot node3_, puis reprenez à link:install_boot_node3.html#step23["Étape 23"]. 
|===
...
. Si le système passe en boucle de redémarrage avec le message `no disks found`, Il indique que le système a réinitialisé les ports FC ou UTA/UTA2 dans le mode cible et ne parvient donc pas à voir les disques. Pour résoudre ce problème, continuez avec ,Étape 17 à ,Étape 22, ou allez à la section link:verify_node3_installation.html["Vérifiez l'installation du noeud 3"].
