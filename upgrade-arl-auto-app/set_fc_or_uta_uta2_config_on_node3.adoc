...
| Dispose d'une carte UTA/UTA2 ou de ports UTA/UTA2 intégrés | Allez à <<check-config-uta-uta2-node3,Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>> 
