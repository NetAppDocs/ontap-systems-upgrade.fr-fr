...
.Et la suite ?
Après avoir déplacé les agrégats non racines et les LIF de données NAS du nœud 2 vers le nœud 3, link:relocate-failed-or-vetoed-aggr-node3.html["déplacer les agrégats ayant échoué ou refusés"].
