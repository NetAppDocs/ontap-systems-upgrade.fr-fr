...
.Et la suite ?
Après avoir vérifié les erreurs de configuration de MetroClusterlink:verify_switchover_healing_switchback.html["vérifier la commutation, la restauration et le retour en arrière"].
