...
+
Si vous ne disposez pas de configuration FC ou UTA/UTA2, effectuez les opérations link:reassign-node2-disks-to-node4.html#reassign-node1-node3-app-step1["Réaffectez les disques du nœud 1 au nœud 3, étape 1"] pour que le nœud 3 puisse reconnaître les disques du nœud 1.
