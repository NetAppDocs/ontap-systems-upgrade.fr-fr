...
+
Si vous ne disposez pas de configuration FC ou UTA/UTA2, effectuez les opérations link:reassign-node1-disks-to-node3.html#reassign-node1-node3-app-step1["Réaffectez les disques du nœud 1 au nœud 3, étape 1"] pour que le nœud 3 puisse reconnaître les disques du nœud 1.
