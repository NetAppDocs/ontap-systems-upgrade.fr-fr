...
.Et la suite ?
Après avoir déplacé les agrégats non racines et les LIF de données NAS appartenant au nœud 1 vers le nœud 2, link:relocate-failed-or-vetoed-aggr-node2.html["déplacer les agrégats ayant échoué ou refusés"].
