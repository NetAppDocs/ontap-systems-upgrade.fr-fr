...
[NOTE]
====
* Si vous mettez à niveau un système en remplaçant les modules de contrôleur dans le même châssis, comme AFF A800 ou AFF C800, NetApp recommande fortement d'utiliser la procédure de mise à niveau qui link:../upgrade-arl-auto-in-chassis/index.html["met à niveau les modèles de contrôleurs à l'aide d'ARL, en conservant le châssis, les disques et les données du système existant"]. Cette procédure ARL inclut les étapes permettant de garantir que les disques internes restent sécurisés dans le châssis lors du retrait et de l'installation des contrôleurs pendant la procédure de mise à niveau.
+
link:../upgrade-arl-auto-in-chassis/decide-to-use-the-aggregate-relocation-guide.html#supported-systems-in-chassis["Découvrez les combinaisons de mise à niveau système prises en charge à l'aide d'ARL, en conservant le châssis, les disques et les données du système existant"].
...
^4^Le tableau suivant présente les versions ONTAP prises en charge pour les combinaisons de mise à niveau du contrôleur.
...
| FAS2720 | 9.13.1 ou version ultérieure | FAS2820 | 9.13.1 ou version ultérieure 


| FAS2760 | 9.11.1P7 ou antérieure | FAS2820 | 9.13.1 ou version ultérieure 
...
.Et la suite ?
Après avoir décidé d'utiliser ou non cette procédure ARL, renseignez-vous sur le link:required_tools_and_documentation.html["outils et documentation requis"].
