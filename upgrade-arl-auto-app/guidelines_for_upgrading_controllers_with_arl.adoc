...
* Aux contrôleurs d'entrée de gamme avec disques internes, par exemple : un FAS2750.
+
...
.Et la suite ?
Après avoir examiné les directives de mise à niveau des contrôleurs avec ARL, link:verify_health_of_metrocluster_config.html["vérifier l'état de la configuration MetroCluster"].
