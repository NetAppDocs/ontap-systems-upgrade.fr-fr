...
.Et la suite ?
Après avoir restauré la configuration du gestionnaire de clés sur le nœud 4, link:move_non_root_aggr_and_nas_data_lifs_node2_from_node3_to_node4.html["Déplacez les agrégats non root et les LIF de données NAS appartenant au nœud2 du nœud3 vers le nœud4"].
