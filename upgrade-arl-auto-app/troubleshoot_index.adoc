...
summary: 'Diagnostiquez les défaillances qui peuvent se produire lors de la mise à niveau des contrôleurs exécutant ONTAP 9.8 ou version ultérieure en utilisant `system controller replace` commandes.' 
---
