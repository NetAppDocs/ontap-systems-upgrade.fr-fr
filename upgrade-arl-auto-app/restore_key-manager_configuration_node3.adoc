...
.Et la suite ?
Après avoir restauré la configuration du gestionnaire de clés sur le nœud3, link:move_non-root_aggr_and_nas_data_lifs_node1_from_node2_to_node3.html["Déplacer les agrégats non racines et les LIF de données NAS appartenant à node1 de node2 vers node3"].
