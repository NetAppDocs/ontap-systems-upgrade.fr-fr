...
summary: 'Déplacez manuellement les agrégats défaillants ou refusés vers le nœud 3 lors de la mise à niveau des contrôleurs exécutant ONTAP 9.8 ou version ultérieure à l"aide de `system controller replace` commandes.' 
---
...
.Et la suite ?
Après le déplacement des agrégats défaillants ou rejetés, link:retire_node2.html["retirer node2"].
