...
summary: 'Si nécessaire, configurez le nouveau module de contrôleur pour NVE lors de la mise à niveau des contrôleurs qui exécutent ONTAP 9.8 ou version ultérieure en utilisant `system controller replace` commandes.' 
---
