...
. Vous pouvez éventuellement mettre hors service le nœud 1 une fois la mise à niveau terminée. Voir link:decommission_old_system.html["Désaffectation de l'ancien système"].


.Et la suite ?
Après la mise hors service du nœud 1, link:prepare_for_netboot.html["Préparation au démarrage réseau"].
