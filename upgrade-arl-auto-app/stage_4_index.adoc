...
[role="lead"]
Lors de la phase 4, vous transférez les agrégats non racines et les LIF de données NAS du nœud 2 vers le nœud 3. Vous devez enregistrer les informations nécessaires sur le noeud 2 pour une utilisation ultérieure dans la procédure, puis retirer le noeud 2.
