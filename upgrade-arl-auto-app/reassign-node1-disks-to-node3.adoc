...
.Étapes
. Accédez au menu de démarrage et, à l'aide du 22/7, sélectionnez l'option cachée `boot_after_controller_replacement` . À l'invite, entrez node1 pour réaffecter les disques du nœud1 au nœud3, comme dans l'exemple suivant.
+
