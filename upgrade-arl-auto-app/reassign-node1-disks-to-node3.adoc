...
.Étapes
. [[reassign-node1-node3-app-step1]]Vérifiez que le nœud 1 s'est arrêté au menu de démarrage.  Réaffecter les disques du nœud 1 au nœud 3 :
+
...
+
** Effectuer<<reassign-node1-node3-app-step3,Étape 3>> à<<reassign-node1-node3-app-step8,Étape 8>> sur le nœud 3
** Accéder à la sectionlink:verify_node3_installation.html["Vérifiez l'installation du noeud 3"]
...
.Et la suite ?
Après avoir réaffecté les disques du nœud 1 au nœud 3, link:verify_node3_installation.html["vérifiez l'installation de node3"].
