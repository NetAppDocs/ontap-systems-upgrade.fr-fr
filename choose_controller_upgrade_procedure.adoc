...
NOTE: Vous pouvez également mettre à niveau un système AFF A800 vers un système AFF A70 ou AFF A90 à l'aide du déplacement d'agrégats. link:https://docs.netapp.com/us-en/ontap-systems-upgrade/upgrade-arl-auto-app-9151/index.html["En savoir plus >>"].
