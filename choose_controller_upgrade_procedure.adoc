...
* link:upgrade/upgrade-decide-to-use-this-guide.html["Déplacer le stockage"]
+
Vous pouvez effectuer une mise à niveau sans interruption d'un AFF A250 vers un AFF A400 ou d'un FAS2820 vers un système de remplacement en convertissant les nœuds d'origine en baies de disques, puis en connectant les baies de disques aux nœuds de remplacement pour déplacer le stockage embarqué.
