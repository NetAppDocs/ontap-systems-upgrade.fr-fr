...
* Si vous mettez à niveau un système V-Series ou un système avec le logiciel de virtualisation FlexArray connecté aux baies de stockage, vous devez le faire ,Étape 1 à ,Étape 7, laissez cette section à ,Étape 8 et suivez les instructions de la section link:set_fc_uta_uta2_config_node4.html["Définissez la configuration FC ou UTA/UTA2 sur le nœud 4"] Si nécessaire, saisir les commandes en mode maintenance. Vous devez ensuite revenir à cette section et reprendre la procédure à ,Étape 9.
...
| Châssis séparé du nœud3 | Accédez à ,Étape 2. 


| Châssis identique à celui du nœud3 | Ignorez les étapes 2 et 3 et passez à ,Étape 4. 
|===
...
| Châssis identique à celui du nœud 3 | Accédez à ,Étape 8. 


| Châssis séparé du nœud3 | Accédez à ,Étape 6. 
|===
...
| Possède des disques et aucun stockage interne | Passez aux étapes 9 à 14 et passez à ,Étape 15. 
...
.. Revenez à cette section et suivez les étapes restantes, en commençant par ,Étape 9.
...
| Ne dispose pas de la version ONTAP correcte ou actuelle du système node4 | Accédez à ,Étape 20. 


| Dispose de la version correcte ou à jour de ONTAP sur le nœud 4 | Accédez à ,Étape 25. 
|===
...
|===
+
Pour le `<node2_sysid>` valeur, utilisez les informations capturées dans link:record_node2_information.html#man_node2_info_step10["Étape 10"] De la section _Record node2 information_. Pour `_node4_sysid_`, utilisez les informations capturées dans ,Étape 23.
...
. Vérifiez que l'ID du système partenaire est correctement défini comme indiqué dans la ,Étape 26 sous option.
+
