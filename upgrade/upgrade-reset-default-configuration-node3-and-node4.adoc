...
----
+
Le système lance la  `wipeconfig`procédure et redémarre. Une fois la procédure terminée, le système revient au menu de démarrage.

. Dans le menu de démarrage, entrez 8 pour redémarrer le nœud, et entrez Ctrl-C pendant AUTOBOOT pour arrêter le nœud à l'invite LOADER.
