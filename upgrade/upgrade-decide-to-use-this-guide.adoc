...
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["Découvrez comment convertir AFF A250 en baie de disques et transférer le stockage vers AFF A400"] (procédure sans interruption)
* link:convert-to-drive-shelf.html["Mettez à niveau depuis AFF A150, AFF A220 ou FAS2820 en convertissant en un shelf de disques"] (procédure sans interruption)
