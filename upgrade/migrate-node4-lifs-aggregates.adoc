...
summary: 'Pour terminer la mise à niveau, connectez le node3 au node4, puis migrez les interfaces logiques de données (LIF) et les agrégats de données du node4 vers le node3.' 
---
...
[role="lead"]
Pour terminer la mise à niveau, connectez le node3 au node4, puis migrez les interfaces logiques de données (LIF) et les agrégats de données du node4 vers le node3.
