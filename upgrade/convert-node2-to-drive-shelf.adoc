...
[role="lead"]
Convertissez AFF A150, AFF A220 ou FAS2820 node2 en un shelf de disques et connectez-le à node4 avant de réaffecter les disques de node2 à node4. Node1 et node2 sont les contrôleurs à l'intérieur du shelf de disques.
