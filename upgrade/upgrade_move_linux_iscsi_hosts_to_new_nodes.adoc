...
summary: Déplacez vos volumes SAN vers les nouveaux nœuds en créant de nouvelles connexions iSCSI et en repassant les chemins iSCSI vers les nouveaux nœuds. 
---
...
Si vous n'avez pas besoin de déplacer des volumes SAN iSCSI lors de la mise à niveau en déplaçant des volumes, vous pouvez ignorer cette procédure et passer à l' link:upgrade-create-aggregate-move-volumes.html["Création d'un agrégat et déplacement des volumes vers les nouveaux nœuds"].
...
.Et la suite ?
link:upgrade-create-aggregate-move-volumes.html["Création d'un agrégat et déplacement des volumes vers les nouveaux nœuds"]
