...
.Étapes
. Mettez sous tension le nœud 3, puis entrez immédiatement Ctrl-C dans le terminal de la console pour accéder à l'invite LOADER.
+
...
+
Saisissez votre nom d'utilisateur et votre mot de passe, le cas échéant, ou appuyez sur Entrée pour continuer.
