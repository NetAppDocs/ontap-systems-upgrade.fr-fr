...
[role="lead"]
Migrez les agrégats de données, epsilon et les interfaces logiques (LIF) sur AFF A150, AFF A220 ou FAS2820 node1 vers node4.
...
.Et la suite ?
link:convert-node1-to-drive-shelf.html["Convertissez le nœud 1 en tiroir disque et connectez-vous au nœud 3"]
