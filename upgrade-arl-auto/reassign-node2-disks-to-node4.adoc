...
NOTE: Vous pourriez rencontrer une erreur à cette étape.  En cas d'erreur, répétez les sous-étapes dans<<auto_check_4_step8,Étape 8>> jusqu'à ce que le système démarre normalement.
