...
Vous devrez peut-être remplir <<configure-fc-ports-on-node3,Configurez les ports FC sur le nœud 3>>, ou <<check-config-uta-uta2-node3,Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>>, ou les deux sections.
...
== Étape 1 : Configurer les ports FC sur le nœud 3
...
.Description de la tâche
Vous pouvez ignorer cette section si votre système ne dispose pas de configurations FC. Si votre système possède des ports UTA/UTA2 intégrés ou une carte UTA/UTA2, vous les configurez dans <<check-config-uta-uta2-node3,Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>>.
...
+
** Si le nœud 3 possède une carte UTA/UTA2 ou des ports intégrés UTA/UTA2, rendez-vous à <<check-config-uta-uta2-node3,Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>>.
** Si le nœud 3 ne possède pas de carte UTA/UTA2 ou de ports intégrés UTA/UTA2, ignorez <<check-config-uta-uta2-node3,Vérifiez et configurez les ports UTA/UTA2 sur le nœud 3>> et passez à link:reassign-node1-disks-to-node3.html["Réaffectez les disques du nœud 1 au nœud 3"].
...
== Étape 2 : Vérifier et configurer les ports UTA/UTA2 sur le nœud 3
