...
| link:prepare_nodes_for_upgrade.html["Étape 1. Préparation à la mise à niveau"]  a| 
...
| link:relocate_non_root_aggr_and_nas_data_lifs_node1_node2.html["Étape 2. Transférez et retirez le nœud 1"]  a| 
