...
+
Si vous effectuez une mise à niveau vers un système A800, rendez-vous sur link:reassign-node2-disks-to-node4.html#auto_check_4_step9["Réaffectez les disques du nœud 2 au nœud 4, étape 9"].
