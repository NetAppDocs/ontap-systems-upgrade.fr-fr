...
CAUTION: À ce stade, la configuration de MetroCluster ne sera pas dans un état normal et vous pourriez avoir des erreurs à résoudre. Voirlink:verify_health_of_metrocluster_config.html["Vérifier l'état de santé de la configuration MetroCluster"] .
