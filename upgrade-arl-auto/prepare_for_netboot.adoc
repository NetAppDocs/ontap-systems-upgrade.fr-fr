...
Toutefois, vous n'avez pas besoin d'effectuer le démarrage sur les contrôleurs si la même version de ONTAP 9 est installée sur les contrôleurs d'origine. Si c'est le cas, vous pouvez ignorer cette section et passer à link:stage_3_install_boot_node3_overview.html["Étape 3 installation et démarrage du noeud 3"]
