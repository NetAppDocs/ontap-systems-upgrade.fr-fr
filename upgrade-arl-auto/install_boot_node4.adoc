...
. [[step29]] pour les configurations MetroCluster, les systèmes V-Series et les systèmes avec le logiciel de virtualisation FlexArray connecté aux baies de stockage, allez à LINK:set_fc_or_uta_uta2_config_node4.html# auto_check_4_step15[Vérification et configuration des ports UTA/UTA2 sur le node4, étape 15].
