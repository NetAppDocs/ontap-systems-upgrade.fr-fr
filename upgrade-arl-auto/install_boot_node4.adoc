...
. [[auto_install4_step27]]Si vous avez installé des lecteurs NetApp Storage Encryption (NSE), procédez comme suit :
+
...
+
Si vous ne disposez pas de configuration FC ou UTA/UTA2, effectuez les opérations link:reassign-node2-disks-to-node4.html#reassign-node2-node4-step1["Réaffectez les disques du nœud 2 au nœud 4, étape 1"] pour que le nœud 4 puisse reconnaître les disques du nœud 2.

. [[Etape 29]] pour les configurations MetroCluster, les systèmes V-Series et les systèmes avec le logiciel de virtualisation FlexArray connecté à des baies de stockage, rendez-vous sur link:reassign-node2-disks-to-node4.html#reassign-node2-node4-step1["Réaffectez les disques du nœud 2 au nœud 4, étape 1"].
