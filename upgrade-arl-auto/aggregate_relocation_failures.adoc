...
summary: 'Dépanner les défaillances de transfert d"agrégats qui peuvent se produire lors de la mise à niveau des contrôleurs exécutant ONTAP 9.5 vers 9.7 en utilisant `system controller replace` commandes.' 
---
