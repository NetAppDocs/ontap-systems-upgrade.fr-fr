...
| Dans un environnement SAN | Terminé ,Étape 4 ensuite, passez à la section link:move_nas_lifs_node1_from_node2_node3_verify_san_lifs_node3.html["Déplacement des LIF de données NAS qui appartiennent au nœud 1, du nœud 2 au nœud 3, et vérification des LIF SAN sur le nœud 3"]. 
