...
. [[man_install3_step16]]si des disques de cryptage de stockage NetApp sont installés, effectuez les opérations suivantes.
+
...
| Les disques NetApp Storage Encryption (NSE) conformes à la norme FIPS 140-2 de niveau 2 | `setenv bootarg.storageencryption.support *true*` 
