...
[role="lead"]
Les ports physiques du nœud 2 doivent correspondre correctement aux ports physiques du nœud 4. Cela permet au nœud 4 de communiquer avec les autres nœuds du cluster et avec le réseau après la mise à niveau.
...
+
Pour plus d'informations, reportez-vous à link:other_references.html["Références"] pour accéder à _Gestion du réseau_ ou au _ONTAP 9 Command reference_, et accédez à _Configuring failover settings on a LIF_.
