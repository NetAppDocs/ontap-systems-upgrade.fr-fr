...
summary: 'Préparation au démarrage sur le nœud node3 et sur le nœud 4 lors d"une mise à niveau manuelle du transfert d"agrégats sur des contrôleurs exécutant ONTAP 9.7 ou une version antérieure.' 
---
...
|===
+
Vous utiliserez les informations contenues dans les répertoires dans link:install_boot_node3.html["Étape 3"] .
