...
| link:https://docs.netapp.com/us-en/ontap-cli/index.html["ONTAP 9 Référence des commandes"^] | Décrit la syntaxe et l'utilisation des commandes ONTAP prises en charge. 
